                    ...
                    Else
                        ...
                        Else
                            ...
                            ElseIf DiasCadaPeriodo = 6 Or DiasCadaPeriodo = 7 Then
                                'If dtgDatos.Rows(x).Cells(2).Value = "107" Then
                                'MsgBox("llego")
                                'End If
                                ...
                                Else
                                    ...
                                    Else
                                        ...
                                        Else
                                            dtgDatos.Rows(x).Cells(30).Value = Math.Round(SDEMPLEADO * (0.16666 * (diastrabajados - FINJUSTIFICADA)), 7).ToString("###,##0.00")
